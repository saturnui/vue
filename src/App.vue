...
<template>
  <div class="vuwi-window bg-white filter shadow-lg">
    <div class="border-t">
      <div class="vuwi-content p-3 space-y-4">
        <button class="btn btn-primary">Button</button>
        <div
          class="flex gap-2 p-4 bg-gray-100 filter shadow-md overflow-x-auto"
        >
          <Avatar
            name="Rob Taylor"
            :photo="photo"
        ...
        <div class="flex gap-4 p-4 bg-gray-100 filter shadow-md">
          ...
          <Switch v-model="showSnackbar">
            <span class="ml-2">Show Snackbar</span>
          </Switch>
        </div>
  ...
  <!-- <div class="fixed top-0 left-0 w-screen h-screen bg-white">
    <div class="fixed top-0 right-0 bg-primary w-full h-full max-w-md">x</div>
    <div class="fixed top-0 left-0 bg-red-400 w-full h-full max-w-md">x</div>
    <div class="fixed bottom-0 left-0 bg-yellow-400 w-full">
  ...
  <Snackbar
    ...
    cancel="Dismiss"
    confirm="Ok"
    @click:cancel="showSnackbar = false"
    @click:confirm="showSnackbar = false"
  >
    <template #icon>
