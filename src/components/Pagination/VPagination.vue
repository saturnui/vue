...
import VChevronLeftIcon from '../Icon/VChevronLeftIcon.vue'
import VChevronRightIcon from '../Icon/VChevronRightIcon.vue'

export default defineComponent({
  components: { VChevronLeftIcon, VChevronRightIcon },
  props: {
    component: {
      type: String,
      default: 'pagination',
...
<template>
  <nav :class="component" role="navigation">
