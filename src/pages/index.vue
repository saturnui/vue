  ...
  <div class="grid gap-4 p-4">
    ...
    <div class="vuwi-window">
      ...
      <div class="vuwi-content p-3 space-y-1">
        <div class="font-bold text-lg bg-gray-100 dark:bg-gray-700 mx-4 px-4 py-2 rounded">
          Tooltip
        </div>
    ...
    <div class="vuwi-window">
      ...
      <div class="vuwi-content p-3 space-y-4">
        <div class="font-bold text-lg bg-gray-100 dark:bg-gray-700 px-4 py-2 rounded">
          Button Link
        </div>
    ...
    <div class="vuwi-window">
      <Line />
      <div class="vuwi-content p-3 space-y-4">
        <div class="font-bold text-lg bg-gray-100 dark:bg-gray-700 px-4 py-2 rounded">Form</div>
        <Textfield
          v-model="text"
          label="First name"
          required
    ...
    <div class="vuwi-window">
      <Line />
      <div class="vuwi-content p-3 space-y-4">
        <div class="font-bold text-lg bg-gray-100 dark:bg-gray-700 px-4 py-2 rounded">Code</div>
        <div class="vuwi-content p-3 space-y-1">
          <div class="vuwi-row gap-4">
            <CodeInput v-model="code" />
            <div class="bg-gray-900 rounded-full py-1 px-4 text-2xl font-bold">
              {{ code }}
            </div>
          </div>
        </div>
