  ...
  <div class="grid grid-cols-7 gap-y-0.5 my-1">
    ...
    >
      <div
        ...
        :key="keyDate"
        class="relative"
        :class="{ 'vuwi-tooltip': asRange && date.duration() }"
      ...
      >
        ...
        <button
          type="button"
          class="vuwi-datepicker-date relative w-12 h-12 lg:w-10 lg:h-10 flex justify-center items-center text-xs 2xl:text-sm focus:outline-none"
          :class="[
...
<!--    clip-path: polygon(-->
<!--      calc(var(&#45;&#45;vuwi-datepicker) * -1) calc(var(&#45;&#45;vuwi-datepicker) * -1),-->
<!--      calc(100% + var(&#45;&#45;vuwi-datepicker))-->
<!--        calc(var(&#45;&#45;vuwi-datepicker) * -1),-->
<!--      calc(100% + var(&#45;&#45;vuwi-datepicker))-->
<!--        calc(100% + var(&#45;&#45;vuwi-datepicker))-->
<!--    );-->
<!--  }-->
