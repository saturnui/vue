<template>
  <div
    ref="wiDateRangePicker"
    v-wi.away
    class="relative w-full"
    :class="{ 'wi-datepicker-overlay': overlay, 'open': isShow && overlay }"
  >
    <slot
      :value="pickerValue"
    ...
    >
      <label class="relative block">
        <input
          ...
          v-model="pickerValue"
          type="text"
          class="bg-white dark:bg-dark-800 text-black dark:text-white relative block w-full pl-3 pr-12 py-2 rounded-md overflow-hidden text-sm text-gray-700 placeholder-gray-400 transition-colors border wi-border focus:border-blue-300 focus:ring focus:ring-blue-500 focus:ring-opacity-10 focus:outline-none dark:border-gray-700 dark:text-gray-100 dark:placeholder-gray-500 dark:focus:border-blue-500 dark:focus:ring-opacity-20"
          v-bind="$attrs"
          :placeholder="givenPlaceholder"
    ...
    >
      ...
      >
        <div class="bg-white dark:bg-dark-800 text-black dark:text-white fixed inset-0 z-50 overflow-y-auto sm:overflow-visible sm:static sm:z-auto sm:rounded-lg shadow-sm">
          <div
            class="wi-datepicker border wi-border w-full static sm:relative  sm:rounded-lg sm:shadow-sm px-3 py-3 sm:px-1 sm:py-1.5"
                ...
                >
                  ...
                  <div class="px-0.5 sm:px-2">
                    ...
                    <div v-show="panel.previous.calendar">
                      <v-date-picker-week :weeks="weeks"></v-date-picker-week>
                      <v-date-picker-calendar
                        :calendar="calendar.previous"
                        :weeks="weeks"
                        :as-range="asRange()"
            ...
            <div v-if="!autoApply">
              ...
              >
                <div class="mt-1.5 sm:flex sm:flex-row-reverse">
                  <button
                    type="button"
                    class="away-apply-picker w-full transition ease-out duration-300 inline-flex justify-center rounded-md border border-transparent shadow-sm p-4 py-2 bg-blue-600 text-base font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 sm:ml-3 sm:w-auto sm:text-sm dark:ring-offset-gray-800 disabled:cursor-not-allowed"
                    :disabled="
                  ...
                  <button
                    type="button"
                    class="mt-3 away-cancel-picker w-full transition ease-out duration-300 inline-flex justify-center rounded-md border border-gray-300 shadow-sm p-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm dark:ring-offset-gray-800"
