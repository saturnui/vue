<template>
  ...
  >
    ...
    >
      <label class="relative block">
        <input
          ...
          v-model="pickerValue"
          type="text"
          class="relative block w-full pl-3 pr-12 py-2 rounded-md overflow-hidden text-sm text-gray-700 placeholder-gray-400 transition-colors border vuwi-border focus:border-blue-300 focus:ring focus:ring-blue-500 focus:ring-opacity-10 focus:outline-none dark:border-gray-700 dark:text-gray-100 dark:placeholder-gray-500 dark:focus:border-blue-500 dark:focus:ring-opacity-20"
          v-bind="$attrs"
          :placeholder="givenPlaceholder"
    ...
    >
      ...
      >
        <div class="fixed inset-0 z-50 overflow-y-auto sm:overflow-visible sm:static sm:z-auto sm:rounded-lg shadow-sm">
          <div
